...
Right-click on your PowerShell shortcut and select "Run as administrator". For more practical access to the options, use [CommandPrompt+PowerShell.reg](https://github.com/TogoFire/DesktopGoose/blob/main/CommandPrompt%2BPowerShell.reg).
